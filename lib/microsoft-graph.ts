...
export async function getMicrosoftAccessToken(
  ...
  if (stillValid) return connection.msAccessToken;

  if (!connection.msRefreshToken) return connection.msAccessToken;
  ...
  await prisma.workspaceMicrosoftConnection.update({
    ...
    data: {
      ...
      ...(json.refresh_token ? { msRefreshToken: json.refresh_token } : {}),
