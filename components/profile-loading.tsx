...
export function ProfilePageSkeleton() {
  const closedAccordionRows = [
    { key: "security", barClass: "h-5 w-40 rounded-md bg-slate-200 dark:bg-slate-800" },
    { key: "linked", barClass: "h-5 w-56 rounded-md bg-slate-200 dark:bg-slate-800" },
    { key: "billing", barClass: "h-5 w-48 rounded-md bg-slate-200 dark:bg-slate-800" },
  ];
  ...
  return (
    <div className="flex h-full w-full flex-col items-center justify-start pb-8 pt-8">
      ...
      <div className="mb-8 flex animate-pulse flex-col items-center space-y-4 px-4 text-center">
        ...
        <div className="h-4 w-80 max-w-full rounded-md bg-slate-200 dark:bg-slate-800" />
      </div>
        ...
        <div className="flex flex-col gap-8 rounded-2xl border border-border/60 bg-card p-6 shadow-sm md:p-8">
          <div className="flex animate-pulse items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <div className="h-6 w-32 rounded-md bg-slate-200 dark:bg-slate-800" />
            </div>
          </div>
