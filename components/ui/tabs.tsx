...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      "inline-flex h-11 w-full items-center justify-center rounded-2xl border border-[color:var(--sk-border)] bg-[image:var(--sk-sunken)] p-1 text-muted-foreground shadow-[var(--sk-sunken-shadow)]",
      className,
    )}
    {...props}
  />
