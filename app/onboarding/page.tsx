...
import { Building2, Target, Briefcase, ArrowRight, ArrowLeft, Sparkles, MessageSquare, Check } from "lucide-react";
  ...
  return (
    <div className="min-h-screen w-full flex flex-col justify-center items-center bg-muted/20 dark:bg-background p-4 relative overflow-hidden">
      ...
      <div className="w-full max-w-[600px] flex flex-col gap-6 relative z-10 py-10">
        ...
        {/* Hlavička s logem a indikátorem kroků */}
          ...
          {step === 1 && (
            <div className="flex-1 flex flex-col animate-in fade-in slide-in-from-right-4 duration-300">
              ...
              <div className="flex justify-end pt-6 mt-auto">
                <Button onClick={nextStep} disabled={!formData.companyName} className="h-12 px-8 rounded-xl bg-blue-600 hover:bg-blue-700 text-white font-bold group">
                  Pokračovat <ArrowRight className="ml-2 h-4 w-4 transition-transform group-hover:translate-x-1" />
                </Button>
              </div>
            </div>
          )}
          ...
          {step === 2 && (
            <div className="flex-1 flex flex-col animate-in fade-in slide-in-from-right-4 duration-300">
              ...
              <div className="flex justify-between pt-6 mt-auto">
                <Button variant="ghost" onClick={prevStep} className="h-12 px-4 text-muted-foreground hover:text-foreground">
          ...
          {step === 3 && (
            <div className="flex-1 flex flex-col animate-in fade-in slide-in-from-right-4 duration-300">
              ...
              <div className="flex justify-between pt-6 mt-auto">
                ...
                <Button onClick={nextStep} disabled={!formData.targetAudience || (formData.targetAudience === "Jiné" && !formData.customTarget)} className="h-12 px-8 rounded-xl bg-blue-600 hover:bg-blue-700 text-white font-bold group">
                  Poslední krok <ArrowRight className="ml-2 h-4 w-4 transition-transform group-hover:translate-x-1" />
                </Button>
              </div>
            </div>
          )}

          {/* KROK 4: Tón komunikace */}
          {step === 4 && (
            <div className="flex-1 flex flex-col animate-in fade-in slide-in-from-right-4 duration-300">
              <div className="mb-8">
              ...
              <div className="flex-1 grid grid-cols-1 gap-3">
                {TONES.map((toneOption) => (
                  ...
                  >
                    ...
                    <div>
                      <h3 className={cn("font-bold text-sm", formData.tone === toneOption.id ? "text-blue-700 dark:text-blue-400" : "text-foreground")}>
                        {toneOption.label}
                      </h3>
              ...
              <div className="flex justify-between pt-6 mt-auto">
                <Button variant="ghost" onClick={prevStep} disabled={isLoading} className="h-12 px-4 text-muted-foreground hover:text-foreground">
                  <ArrowLeft className="mr-2 h-4 w-4" /> Zpět
                </Button>
                <Button 
